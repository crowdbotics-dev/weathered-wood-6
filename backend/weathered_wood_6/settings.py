"""
Django settings for weathered_wood_6 project.
...
ROOT_URLCONF = 'weathered_wood_6.urls'
...
WSGI_APPLICATION = 'weathered_wood_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_wood_6 API",
    "DESCRIPTION": "API documentation for weathered_wood_6 App",
    "VERSION": "v1",
}
